...
import * as renderMod from './renderModule.js';
...
function resetGame(){
    ...
    resetScore();
    updateScore();
    renderMod.resetClock(currentTime);
    resetRecordArray();
    updateRecord();
		hideAutoFillButton();
		gameOver = false;
...
renderMod.addClickEventListenerToStartClock(clockSetIntervalFunction, currentTime);
